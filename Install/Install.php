...
namespace Apps\Tms\Packages\Jobs\Expenses\Install;

use Apps\Tms\Packages\Jobs\Expenses\Install\Schema\JobsExpenses;
...
class Install extends BasePackage
{
    ...
    public function init()
    {
        $this->databases =
            [
                'apps_tms_jobs_expenses'  => [
                    'schema'        => new JobsExpenses,
                    'model'         => new AppsTmsJobsExpenses
                ],
            ];
